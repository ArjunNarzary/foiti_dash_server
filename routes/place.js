...
const { allPlaces, getPlace, changeName, updateCoors, changeAddress, addEditCustomType, addEditAlias, changeDisplayAddress, searchPlace, setOriginalPlace, deleteOriginalPlace, toggleShowDestination, toggleDestination, setSearchRank, setEditorRating, mergeDisplayAddress, changeCover } = require("../controllers/place");
